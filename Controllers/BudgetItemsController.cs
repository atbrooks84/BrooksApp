...
namespace BrooksApp.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Ammount,BudgetId,Description,Created,Recurring")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Ammount,BudgetId,Description,Created,Recurring")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
