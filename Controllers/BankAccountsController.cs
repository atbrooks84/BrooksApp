...
namespace BrooksApp.Controllers
{
    public class BankAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Balance,Created,HouseholdId,Street,City,State,AccountTypeId,OwnerId")] BankAccount bankAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Balance,Created,HouseholdId,Street,City,State,AccountTypeId,OwnerId")] BankAccount bankAccount)
        {
            if (ModelState.IsValid)
            {
