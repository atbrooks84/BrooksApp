...
namespace BrooksApp.Controllers
{
    public class InvitationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SendToEmail,Subject,Description,SenderId,Code,Created,HouseholdId")] Invitation invitation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SendToEmail,Subject,Description,SenderId,Code,Created,HouseholdId")] Invitation invitation)
        {
            if (ModelState.IsValid)
            {
